...
export function Faq() {
  return (
    <section id="faq" className="max-w-3xl mx-auto px-6 lg:px-12 py-24 lg:py-36">
      ...
      <div>
        {FAQS.map((f, i) => (
          <details key={f.q} className="border-t border-walnut-deep/20 py-7 last:border-b group">
            ...
            <p className="font-body text-onyx/85 mt-4 pl-[calc(2ch+1.25rem)] max-w-prose">{f.a}</p>
          </details>
        ))}
      </div>
    </section>
